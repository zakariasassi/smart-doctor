function Body() {
  ...
  return (
    <>
      <div className="w-[90%] flex flex-col justify-center align-middle">
        <p className="text-center text-6xl font-bold mb-10">التشخيص الالي للامراض</p>
        <div>
          <svg
            id="Layer_2"
            data-name="Layer 2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 413 392.62"
          >
            <defs></defs>
            <g id="OBJECTS">
              <g>
